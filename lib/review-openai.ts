...
function buildUserPrompt(
  ...
  return `إليك ${sources.length} مصدر حول نفس الموضوع. مهمتك: اكتب سكريفة عربية أصيلة ومعمّقة — لا تلخيصاً، بل تحليلاً حقيقياً بصوت الكاتب.${memoryBlock}
...
أعد JSON فقط (بدون markdown، بدون backticks):
{
  ...
  "contentAr": "السكريفة الكاملة بتنسيق Markdown (1500–3000 كلمة)",
