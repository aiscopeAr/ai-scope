...
أنت تعيد المحتوى بتنسيق JSON فقط، بدون أي نص خارج JSON.`,
  ...
  team: {
    ...
    voiceTraits: [
      ...
      "يستند إلى أمثلة موثّقة من الأدلة المتاحة دون ادعاء تجربة مباشرة",
...
- صِف سلوك الأداة أو الواجهة فقط بحسب الأدلة المتاحة؛ لا تدّعِ أنك جرّبت الأداة أو شاهدت شاشتها بنفسك
...
أنت تعيد المحتوى بتنسيق JSON فقط، بدون أي نص خارج JSON.`,
  ...
  lina: {
    ...
    voiceTraits: [
      ...
      "تطرح الصلة الإقليمية فقط عند وجود مبرر حقيقي مدعوم بدليل",
    ],
...
- تتناولين الصلة بالمنطقة العربية فقط حين تدعمها الخطة التحريرية بدليل محدد — لا تُضيفي فقرة إقليمية عامة بلا مبرر
