...
// DIAGNOSTIC VARIANT H — request-time rendering (connection()) + cached data (unstable_cache),
// replacing full-page ISR (revalidate=60) to test whether this eliminates hydration #418
// without causing 7 live Prisma queries per request. Not for merge.
...
// All queries below are public/global content (published:true filters only) —
// no user-specific, session-specific, or request-specific data. Safe to share
// one cache key across all visitors.
