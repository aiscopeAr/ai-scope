...
export const metadata: Metadata = {
  ...
  description:
    `${SITE_NAME} منصة عربية متخصصة في تحليل أخبار الذكاء الاصطناعي — تقارير يكتبها كتّاب الذكاء الاصطناعي في لوميك وتُنشر ضمن إشراف تحريري بشري.`,
...
const steps = [
  ...
  { n: "03", title: "التحليل بالذكاء الاصطناعي", body: "يكتب أحد كتّاب لوميك (زيد، لينا، طارق، أو فريق لوميك) تقريراً عربياً أصيلاً — تحليل حقيقي لا ترجمة، بصوت كل كاتب." },
  { n: "04", title: "الإشراف التحريري", body: "تُنشر التقارير آلياً ضمن إشراف وتنسيق تحريري بشري — نراجع المصادر والسياسات ونتدخّل عند الحاجة." },
