...
const sections = [
  ...
  { n: "4", title: "المحتوى المُولَّد بالذكاء الاصطناعي", body: "كتّاب المنصة (زيد، لينا، طارق، وفريق لوميك) أنظمة ذكاء اصطناعي. تقارير لوميك يكتبها الذكاء الاصطناعي وتُنشر آلياً ضمن إشراف وتنسيق تحريري بشري، ونُفصح عن ذلك صراحةً. المحتوى المنشور لا يمثّل آراء شخصية أو مواقف مؤسسية." },
