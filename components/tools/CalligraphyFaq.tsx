const FAQ_ITEMS = [
  {
    ...
    a: "أداة مجانية من Lumiq للكتابة بالخط العربي أونلاين — تتيح لك تصميم اسم أو عبارة بالعربية، واختيار نمط بصري من بين خمسة أنماط، ثم تحميل النتيجة كصورة PNG بخلفية شفافة — كل ذلك مباشرة في متصفحك دون تسجيل.",
  },
  {
    q: "كيف تستخدم الأداة؟",
